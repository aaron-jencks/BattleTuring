...
def main():
    ...
    pygame.display.set_caption('Battle Turing')
    ...
    main_menu = pygame_menu.Menu('Main Menu', 400, 300, theme=pygame_menu.themes.THEME_BLUE)
    single_player_menu = pygame_menu.Menu('Singleplayer', 400, 300, theme=pygame_menu.themes.THEME_BLUE)
    ...
    single_player_menu.add.button('Run', run_simulation)
    single_player_menu.add.button('Change Tape', tape_entry)
    single_player_menu.add.button('Change Code', file_entry)
    single_player_menu.add.button('Back', pygame_menu.events.BACK)

    main_menu.add.button('Singleplayer', single_player_menu)
    main_menu.add.button('Multiplayer')
